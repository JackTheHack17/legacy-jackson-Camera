...
public class ModuleTalonIO extends ModuleIO {
    ...
    public ModuleTalonIO(int id) {
        ...
        switch (key) {
            case "FL" ->
                moduleConstants = SwerveConstants.frontLeft;
            case "FR" ->
                moduleConstants = SwerveConstants.frontRight;
            case "BL" ->
                moduleConstants = SwerveConstants.backLeft;
            case "BR" ->
                moduleConstants = SwerveConstants.backRight;
        }
